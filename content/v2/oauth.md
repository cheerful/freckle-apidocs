...
Before you can start developing with the Noko API, you must first [register your application](https://help.nokotime.com/article/122-registering-a-new-freckle-app). When you register, you will be given a unique Client ID and Secret. Your Client Secret should not be shared.
